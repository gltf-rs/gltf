 ...
 * Conforms fully to the [specification](https://github.com/KhronosGroup/glTF/blob/master/specification/README.md#techniques)
 * Type-safe constants where `GLenum`s are currently provided
